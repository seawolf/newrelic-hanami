...
describe NewRelic::Agent::Instrumentation::Hanami::ActionCallbackSegments do
  ...
  shared_examples 'a Hanami::Action with callbacks' do |**callbacks|
  ...
  context 'with a top-level action class' do
    ...
    it_behaves_like 'a Hanami::Action with callbacks', :before, :after

    context 'with only a `before` callback' do
      let(:klass) do
        Class.new(::Hanami::Action) do
          def self.name
            'Web::Controllers::CustomersDatabase::Index'
      ...
      it_behaves_like 'a Hanami::Action with callbacks', :before
    end

    context 'with only a `after` callback' do
      let(:klass) do
        Class.new(::Hanami::Action) do
          def self.name
            'Web::Controllers::CustomersDatabase::Index'
      ...
      it_behaves_like 'a Hanami::Action with callbacks', :after
    end
  end
